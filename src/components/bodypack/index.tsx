...
const BodyPack = () => {
  return (
    <div className=''>
      ...
      <div className='flex mx-4 md:mx-10 md:px-2'>
        <div className='w-1/2 md:px-2'>
          <p className='text-2xl font-bold md:text-[45px] leading-tight md:leading-snug'>It all started with a 3x2m2 shop, two sewing machines, and courage.</p>
        </div>
        <div className='w-1/2 md:px-2'>
          <p className='text-justify text-xs md:text-xl'>
      ...
      <div className='lg:my-20 my-4 md:my-8 lg:mx-14 mx-4'>
        <Image src={brand} alt='Hero Image 2' layout='responsive' width={500} height={500} className='w-full h-auto' />
      </div>

      <div className='flex md:mx-10 md:px-2 mx-4'>
      ...
      <div className='lg:my-28 my-8 lg:mx-10 mx-4'>
        <p className='text-center text-xl md:text-[50px] leading-none font-semibold'>
          We evaluate the current and the past, then{' '}
          <span className='inline md:block'>
            start work on it in different ways. All for{' '}
            <span className='inline md:block'>
              gaining optimum usefulness, and a better <span className='inline md:block'>impact for all.</span>
            </span>{' '}
          </span>
        </p>
      </div>
      ...
      <div className='lg:my-20 my-8 lg:mx-14 mx-4'>
        <p className='text-center text-xl md:text-[50px] leading-none font-semibold'>
          ...
          <span className='inline md:block'>
            discover that our core is to enable people <span className='inline md:block'>to make a difference in their lives.</span>{' '}
          </span>
        </p>
        <p className='text-center text-xs md:text-xl mt-8 md:mt-16'>
          We aspire to inspire ourselves and others around us to keep moving in their own way, to find their own idea of{' '}
          <span className='inline md:block'>
            making a difference{' '}
            <span className='inline md:block'>
              We believe that every difference matters; from the life-changing improvement to the little joy sparked by daily <span className='inline md:block'>creativity.</span>
            </span>
          </span>
        </p>
      </div>
      <div className='flex flex-col md:flex-row mx-4 md:mx-10 px-2 space-y-8 md:space-y-0 md:space-x-16 mb-12 md:mb-24'>
        ...
        <div className='w-full md:w-1/2 px-2 flex items-center'>
          <div>
            <h1 className='text-xl md:text-6xl leading-none font-semibold mb-2'>Improving the Essentials</h1>
            <p className='text-xs md:text-lg mt-4 text-justify'>
      ...
      <div className='flex flex-col md:flex-row mx-4 md:mx-10 px-2 space-y-8 md:space-y-0 md:space-x-16 mb-12 md:mb-24'>
        ...
        <div className='w-full md:w-1/2 px-2 flex items-center'>
          <div>
            <h1 className='text-xl md:text-6xl leading-none font-semibold mb-2'>Aesthetics Meets Function</h1>
            <p className='text-xs md:text-lg mt-4 text-justify'>
      ...
      <div className='flex flex-col md:flex-row mx-4 md:mx-10 px-2 space-y-8 md:space-y-0 md:space-x-16 mb-12 md:mb-24'>
        ...
        <div className='w-full md:w-1/2 px-2 flex items-center'>
          <div>
            <h1 className='text-xl md:text-6xl leading-none font-semibold mb-2'>More Than a Bag Company</h1>
            <p className='text-xs md:text-lg mt-4 text-justify'>
